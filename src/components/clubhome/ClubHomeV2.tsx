  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 pb-16">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.4fr_1fr_1fr]">
        ...
        {/* middle column */}
        <div className="flex min-w-0 flex-col gap-6">
          {/* §5 Kai Brief. ClubHomeV2 is only reached by NON-FREE solo members
              (free short-circuits to FreeHome in dashboard/page.tsx), so every
              viewer here passes the kai_brief entitlement — the old free-facing
              wall was unreachable and has been removed. */}
        ...
        {/* right column */}
        <div className="flex min-w-0 flex-col gap-6">
          {/* §6 Trending in the Club. Non-free members see the full rankings; the
              free-only locked-rows tail was unreachable here (free → FreeHome). */}
          <div className="flex flex-col gap-3">
            <Trending trending={data.trending} />
          </div>
          {/* §9 For You. Non-free members get the deep read; the free-only upsell
              band was unreachable here (free → FreeHome). */}
          <div className="flex flex-col gap-3">
