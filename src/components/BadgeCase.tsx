...
/**
 * BadgeCase — the family's professional-title credential shelf. Title-card /
 * earned-rank energy (warm-paper + gold), NOT cartoon badges. Earned titles
 * read as awarded credentials; unearned ones are quiet locked placeholders
 * with the subtitle doubling as the "how to earn it" line.
 */
