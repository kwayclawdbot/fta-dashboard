  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      <div>
        <Link
          href="/learn"
          className="group mb-3 inline-flex items-center gap-1.5 text-[13px] font-semibold text-[var(--accent-strong)]"
        >
          <ArrowRight className="h-3.5 w-3.5 rotate-180 transition-transform group-hover:-translate-x-0.5 motion-reduce:transform-none" />
          {isKid ? "Back to my map" : "Back to your journey"}
        </Link>
        <h1 className="font-display text-2xl font-bold text-ink">
          {isKid ? "Full curriculum" : "Explore the curriculum"}
        </h1>
        <p className="text-soft mt-1">
          {isKid
            ? "Every adventure, all in one place."
            : "Browse every course — foundations at your pace, plus the 6-week live program."}
        </p>
      </div>
