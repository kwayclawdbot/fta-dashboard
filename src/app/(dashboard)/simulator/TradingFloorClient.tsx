...
/**
 * THE TRADING FLOOR ITSELF. Unchanged, and moved out of `page.tsx` for exactly
 * one reason: the route needed a SERVER-side register guard in front of it (a
 * kid could open the floor by URL), and a "use client" page cannot carry one.
 * `page.tsx` is now that guard and renders this. Nothing about the engine, the
