/**
 * ClubHome v2 — design-review fixtures. Rich, realistic data for BOTH scale
 * states so the page can be reviewed fully alive before /api/club/* lands.
 *
...
import type { ClubData, ClubScale, CollectiveAvatar } from "./contract";
