...
Canvas: **CHEAT CODE · LIGHT THEME · SAME SYSTEM** · board index 14 · slug `15-discover-screener`
...
- **“discover FOR YOU SCREENER TRENDING Tech …”** → `<div>`
  ...
  - **“discover FOR YOU SCREENER TRENDING Tech …”** → `<div>`
    ...
    - **“FOR YOU SCREENER TRENDING…”** → `<div>`
      ...
      - **"FOR YOU"** → `<span>`
        - box: 51.1x14 · type: color T.neutral-500 / 11px / w600 / ls 0.44px · scale: T.ty90
        - text: "FOR YOU"
      - **"SCREENER"** → `<span>`
        - box: 87x23 · pad: 5px 13px 5px 13px · bg: T.orange-400-b · radius: 16px (T.r16) · type: color T.orange-900 / 10.5px / w800 / ls 0.63px · scale: T.ty104
        - text: "SCREENER"
      - **"TRENDING"** → `<span>`
        - box: 60.4x14 · type: color T.neutral-500 / 11px / w600 / ls 0.44px · scale: T.ty90
        - text: "TRENDING"
    - **“Tech ✕ Mkt cap > $10B ✕ Signal > 70% ✕ +…”** → `<div>`
      - box: 354x27 · display: flex · gap: 7px · margin: 14px 0px 0px 0px · overflow: hidden
      - **"Tech ✕"** → `<span>`
        - box: 58.1x27 · flex: 0 0 auto · flex-shrink: 0 · pad: 6px 11px 6px 11px · bg: T.neutral-0 · border: 1px solid T.orange-400-b · radius: 16px (T.r16) · type: color T.orange-500 / 10.5px / w600 · scale: T.ty101
        - text: "Tech ✕"
      - **"Mkt cap > $10B ✕"** **(MOCK)** → `<span>`
        - box: 108.1x27 · flex: 0 0 auto · flex-shrink: 0 · pad: 6px 11px 6px 11px · bg: T.neutral-0 · border: 1px solid T.orange-400-b · radius: 16px (T.r16) · type: color T.orange-500 / 10.5px / w600 · scale: T.ty101
        - text: "Mkt cap > $10B ✕"
      - **"Signal > 70% ✕"** **(MOCK)** → `<span>`
        - box: 95.5x27 · flex: 0 0 auto · flex-shrink: 0 · pad: 6px 11px 6px 11px · bg: T.neutral-0 · border: 1px solid T.orange-400-b · radius: 16px (T.r16) · type: color T.orange-500 / 10.5px / w600 · scale: T.ty101
        - text: "Signal > 70% ✕"
      - **"+ Filter"** → `<span>`
        - box: 57.5x27 · flex: 0 0 auto · flex-shrink: 0 · pad: 6px 11px 6px 11px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 16px (T.r16) · type: color T.neutral-500 / 10.5px / w600 · scale: T.ty101
        - text: "+ Filter"
    - **“14 MATCHES · SORTED BY CLUB SIGNAL Save …”** → `<div>`
      ...
      - **"14 MATCHES · SORTED BY CLUB SIGNAL"** → `<span>`
        - box: 183.6x11 · type: color T.orange-400 / IBM Plex Mono / 9px · scale: T.ty127
        - text: "14 MATCHES · SORTED BY CLUB SIGNAL"
      - **"Save screen"** → `<span>`
        - box: 56.5x13 · type: color T.orange-500 / 10px / w600 · scale: T.ty116
        - text: "Save screen"
    - **“N NVDA $173.42 ▲4.7% 78% P PLTR $156.90 …”** → `<div>`
      ...
      - **“N NVDA $173.42 ▲4.7% 78%…”** → `<div>`
        - box: 354x46 · display: flex · align: center · gap: 10px · pad: 9px 11px 9px 11px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 12px (T.r13)
        - **"N"** → `<div>`
        ...
        - **“NVDA…”** → `<div>`
          ...
          - **"NVDA"** → `<div>`
            - box: 44x14 · type: color T.orange-900 / IBM Plex Mono / 11px / w600 · scale: T.ty87
            - text: "NVDA"
        - **svg** → `<svg>`
          - box: 52x18 · flex: 0 0 auto · flex-shrink: 0 · overflow: hidden
          - svg: `<svg data-dc-tpl="1203" width="52" height="18" viewBox="0 0 52 18" style="flex: 0 0 auto;"><path data-dc-tpl="1204" d="M0 15 L10 12 L20 13 L30 7 L42 9 L52 2" fill="none" stroke="#0BA05A" stroke-width="1.6"></path></svg>`
          - **block[0]** → `<path>`
            - box: 52x13 · display: inline
        - **"$173.42"** **(MOCK)** → `<span>`
          - box: 80x14 · flex: 1 1 0% · flex-grow: 1 · flex-basis: 0% · type: color T.orange-900 / IBM Plex Mono / 10.5px / align-right · scale: T.ty102
          - text: "$173.42"
        - **"▲4.7%"** **(MOCK)** → `<span>`
          - box: 46x13 · width: 46px · type: color T.teal-600 / IBM Plex Mono / 10px / align-right · scale: T.ty108
          - text: "▲4.7%"
        - **"78%"** **(MOCK)** → `<span>`
          - box: 32x19 · pad: 3px 7px 3px 7px · bg: T.green-400a12 · radius: 8px (T.r9) · type: color T.teal-600 / IBM Plex Mono / 10px / w600 · scale: T.ty110
          - text: "78%"
      - **“P PLTR $156.90 ▲2.1% 74%…”** → `<div>`
        ...
        - **svg** → `<svg>`
          - box: 52x18 · flex: 0 0 auto · flex-shrink: 0 · overflow: hidden
          - svg: `<svg data-dc-tpl="1212" width="52" height="18" viewBox="0 0 52 18" style="flex: 0 0 auto;"><path data-dc-tpl="1213" d="M0 14 L12 15 L22 9 L32 11 L44 4 L52 6" fill="none" stroke="#0BA05A" stroke-width="1.6"></path></svg>`
          - **block[0]** → `<path>`
      ...
      - **“A AMD $182.10 ▲1.9% 71%…”** → `<div>`
        - box: 354x46 · display: flex · align: center · gap: 10px · pad: 9px 11px 9px 11px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 12px (T.r13)
        - **"A"** → `<div>`
          - box: 26x26 · display: grid · align: center · justify-items: center · grid-cols: 26px · grid-rows: 26px · width: 26px · height: 26px · bg: T.magenta-900 · radius: 8px (T.r9) · type: color T.red-400-c / 11px / w800 · scale: T.ty91
          - text: "A"
        - **“AMD…”** → `<div>`
          - box: 44x14 · width: 44px
          - **"AMD"** → `<div>`
        ...
        - **svg** → `<svg>`
          - box: 52x18 · flex: 0 0 auto · flex-shrink: 0 · overflow: hidden
          - svg: `<svg data-dc-tpl="1221" width="52" height="18" viewBox="0 0 52 18" style="flex: 0 0 auto;"><path data-dc-tpl="1222" d="M0 13 L10 14 L22 10 L32 12 L42 6 L52 3" fill="none" stroke="#0BA05A" stroke-width="1.6"></path></svg>`
          - **block[0]** → `<path>`
            - box: 52x11 · display: inline
        - **"$182.10"** **(MOCK)** → `<span>`
          - box: 80x14 · flex: 1 1 0% · flex-grow: 1 · flex-basis: 0% · type: color T.orange-900 / IBM Plex Mono / 10.5px / align-right · scale: T.ty102
    ...
    - **“CLUB'S MOST BULLISH NVDA 78% PLTR 74% AM…”** → `<div>`
      ...
      - **“CLUB'S MOST BULLISH NVDA 78% PLTR 74% AM…”** → `<div>`
        - box: 172x107 · flex: 1 1 0% · flex-grow: 1 · flex-basis: 0% · pad: 13px 14px 13px 14px · bg: T.neutral-0 · border: 1px solid T.green-200 · radius: 16px (T.r16)
        - **"Club's most bullish"** → `<div>`
          - box: 142x11 · type: color T.teal-600 / IBM Plex Mono / 8.5px / w600 / ls 1.19px / uppercase · scale: T.ty140
        ...
        - **“NVDA 78% PLTR 74% AMD 71%…”** → `<div>`
          ...
          - **“NVDA 78%…”** → `<div>`
            ...
            - **"NVDA"** → `<span>`
              ...
              - text: "NVDA"
            - **"78%"** **(MOCK)** → `<span>`
              - box: 18.9x14 · type: color T.teal-600 / IBM Plex Mono / 10.5px · scale: T.ty102
              - text: "78%"
          - **“PLTR 74%…”** → `<div>`
            - box: 142x14 · display: flex · align: center · justify: space-between
            - **"PLTR"** → `<span>`
          ...
          - **“AMD 71%…”** → `<div>`
            - box: 142x14 · display: flex · align: center · justify: space-between
            - **"AMD"** → `<span>`
              - box: 19.8x14 · type: color T.orange-900 / IBM Plex Mono / 11px / w600 · scale: T.ty87
              - text: "AMD"
            - **"71%"** **(MOCK)** → `<span>`
              - box: 18.9x14 · type: color T.teal-600 / IBM Plex Mono / 10.5px · scale: T.ty102
              - text: "71%"
      - **“CLUB'S MOST BEARISH NFLX 68% RIVN 61% LC…”** → `<div>`
        - box: 172x107 · flex: 1 1 0% · flex-grow: 1 · flex-basis: 0% · pad: 13px 14px 13px 14px · bg: T.neutral-0 · border: 1px solid T.red-100 · radius: 16px (T.r16)
        - **"Club's most bearish"** → `<div>`
          - box: 142x11 · type: color T.red-400 / IBM Plex Mono / 8.5px / w600 / ls 1.19px / uppercase · scale: T.ty140
        ...
        - **“NFLX 68% RIVN 61% LCID 57%…”** → `<div>`
          ...
          - **“NFLX 68%…”** → `<div>`
            ...
            - **"NFLX"** → `<span>`
              ...
              - text: "NFLX"
            - **"68%"** **(MOCK)** → `<span>`
              - box: 18.9x14 · type: color T.red-400 / IBM Plex Mono / 10.5px · scale: T.ty102
              - text: "68%"
          - **“RIVN 61%…”** → `<div>`
            - box: 142x14 · display: flex · align: center · justify: space-between
            - **"RIVN"** → `<span>`
    ...
    - **“🔥 SMCI +324% 🔥 IONQ +188% SOFI +167% O…”** → `<div>`
      ...
      - **"🔥 SMCI"** → `<span>`
        - box: 112.6x34 · pad: 7px 12px 7px 12px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 16px (T.r16) · type: color T.orange-900 / IBM Plex Mono / 11px · scale: T.ty89
        - text: "🔥 SMCI"
        - **"+324%"** **(MOCK)** → `<span>`
          - box: 33x14 · display: inline · type: color T.teal-600 · scale: T.ty89
          - text: "+324%"
      - **"🔥 IONQ"** → `<span>`
        - box: 112.6x34 · pad: 7px 12px 7px 12px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 16px (T.r16) · type: color T.orange-900 / IBM Plex Mono / 11px · scale: T.ty89
        - text: "🔥 IONQ"
        - **"+188%"** **(MOCK)** → `<span>`
          ...
          - text: "+188%"
      - **"SOFI"** → `<span>`
        - box: 92x34 · pad: 7px 12px 7px 12px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 16px (T.r16) · type: color T.orange-900 / IBM Plex Mono / 11px · scale: T.ty89
        - text: "SOFI"
        - **"+167%"** **(MOCK)** → `<span>`
          - box: 33x14 · display: inline · type: color T.teal-600 · scale: T.ty89
          - text: "+167%"
      - **"OKLO"** → `<span>`
        - box: 92x30 · pad: 7px 12px 7px 12px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 16px (T.r16) · type: color T.orange-900 / IBM Plex Mono / 11px · scale: T.ty89
        - text: "OKLO"
        - **"+140%"** **(MOCK)** → `<span>`
          - box: 33x14 · display: inline · type: color T.teal-600 · scale: T.ty89
          - text: "+140%"
      - **"APP"** → `<span>`
        - box: 78.8x30 · pad: 7px 12px 7px 12px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 16px (T.r16) · type: color T.orange-900 / IBM Plex Mono / 11px · scale: T.ty89
        - text: "APP"
        - **"−12%"** **(MOCK)** → `<span>`
          - box: 26.4x14 · display: inline · type: color T.red-400 · scale: T.ty89
          - text: "−12%"
