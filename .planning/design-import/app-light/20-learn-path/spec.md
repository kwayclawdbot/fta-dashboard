...
Canvas: **CHEAT CODE · LIGHT THEME · SAME SYSTEM** · board index 19 · slug `20-learn-path`
...
- **“learn 🔥 16 ⚡ 1,240 XP UNIT 2 · MARKETS …”** → `<div>`
  ...
  - **“learn 🔥 16 ⚡ 1,240 XP UNIT 2 · MARKETS …”** → `<div>`
    ...
    - **“learn 🔥 16 ⚡ 1,240 XP…”** → `<div>`
      - box: 354x34 · display: flex · align: center · justify: space-between
      - **"learn"** → `<div>`
        - box: 69.7x34 · type: color T.orange-900 / Kaushan Script / 34px / lh 34px · scale: T.ty2
        - text: "learn"
      - **“🔥 16 ⚡ 1,240 XP…”** → `<div>`
        - box: 117.2x18 · display: flex · align: center · gap: 10px
        - **"🔥 16"** → `<span>`
          - box: 33.8x18 · type: color T.orange-500 / IBM Plex Mono / 11px / w600 · scale: T.ty87
          - text: "🔥 16"
        - **"⚡ 1,240 XP"** **(MOCK)** → `<span>`
          - box: 73.4x18 · type: color T.amber-500 / IBM Plex Mono / 11px / w600 · scale: T.ty87
          - text: "⚡ 1,240 XP"
    - **“UNIT 2 · MARKETS 101 Reading Earnings Re…”** → `<div>`
      - box: 354x61 · display: flex · align: center · gap: 12px · pad: 13px 16px 13px 16px · margin: 14px 0px 0px 0px · bg-image: linear-gradient(120deg, T.orange-100-d 0%, T.orange-50-b 100%) · border: 1px solid T.orange-100-g · radius: 16px (T.r16)
      - **“UNIT 2 · MARKETS 101 Reading Earnings Re…”** → `<div>`
        - box: 252.5x33 · flex: 1 1 0% · flex-grow: 1 · flex-basis: 0%
        - **"Unit 2 · Markets 101"** → `<div>`
          - box: 252.5x11 · type: color T.orange-500 / IBM Plex Mono / 8.5px / w600 / ls 1.19px / uppercase · scale: T.ty140
          - text: "Unit 2 · Markets 101"
        - **"Reading Earnings Reports"** → `<div>`
          - box: 252.5x19 · margin: 3px 0px 0px 0px · type: color T.orange-900 / 15px / w800 · scale: T.ty43
          - text: "Reading Earnings Reports"
      - **"Guide"** → `<span>`
        - box: 55.5x27 · pad: 6px 12px 6px 12px · bg: T.neutral-0a10 · border: 1px solid T.neutral-0a20 · radius: 14px (T.r15) · type: color T.orange-900 / 10.5px / w700 · scale: T.ty103
        - text: "Guide"
    - **“✓ What moves price ✓ EPS & revenue ★ Gui…”** → `<div>`
      ...
      - **“✓ What moves price…”** → `<div>`
        - box: 80.8x74 · transform: matrix(1, 0, 0, 1, -40.4062, 0) · position: absolute [2px 96.1875px 566px 177px] · type: align-center
        - **"✓"** → `<div>`
          - box: 58x58 · display: grid · align: center · justify-items: center · grid-cols: 58px · grid-rows: 58px · width: 58px · height: 58px · bg: T.orange-400-b · radius: 50% (T.r21) · shadow: T.orange-400-c 0px 4px 0px 0px · type: 22px · scale: T.ty20
          - text: "✓"
        - **"What moves price"** → `<div>`
          - box: 80.8x11 · margin: 5px 0px 0px 0px · type: color T.neutral-500 / 9.5px / w600 · scale: T.ty120
      ...
      - **“✓ EPS & revenue…”** → `<div>`
        ...
        - **"✓"** → `<div>`
          ...
          - text: "✓"
        - **"EPS & revenue"** → `<div>`
          - box: 65.3x11 · margin: 5px 0px 0px 0px · type: color T.neutral-500 / 9.5px / w600 · scale: T.ty120
          - text: "EPS & revenue"
      - **“★ Guidance > results…”** → `<div>`
        ...
        - **“★…”** → `<div>`
          ...
          - **block[0]** → `<span>`
            - box: 195.9x195.9 · border: 2px solid T.orange-400a50 · radius: 50% (T.r21) · opacity: 0.0241814 · transform: matrix(2.33229, 0, 0, 2.33229, 0, 0) · position: absolute [-7px -7px -7px -7px]
          - **"★"** → `<div>`
            - box: 70x70 · display: grid · align: center · justify-items: center · grid-cols: 70px · grid-rows: 70px · bg: T.orange-400-b · radius: 50% (T.r21) · shadow: T.orange-400-c 0px 5px 0px 0px · position: absolute [0px 0px 0px 0px] · type: 26px · scale: T.ty9
            - text: "★"
        - **"Guidance > results"** → `<div>`
          - box: 107.7x21 · display: inline-block · pad: 3px 9px 3px 9px · margin: 7px 0px 0px 0px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 10px (T.r11) · type: color T.orange-900 / 10px / w700 · scale: T.ty111
          - text: "Guidance > results"
      - **“🔒 Implied move…”** → `<div>`
        - box: 62x78 · position: absolute [330px 49.5469px 234px 242.453px] · type: align-center
        - **"🔒"** → `<div>`
          - box: 62x62 · display: grid · align: center · justify-items: center · grid-cols: 58px · grid-rows: 58px · width: 58px · height: 58px · bg: T.neutral-0 · border: 2px solid T.orange-100 · radius: 50% (T.r21) · shadow: T.orange-100-e 0px 4px 0px 0px · type: color T.orange-400 / 18px · scale: T.ty29
          - text: "🔒"
        - **"Implied move"** → `<div>`
          - box: 62x11 · margin: 5px 0px 0px 0px · type: color T.orange-400 / 9.5px / w600 · scale: T.ty120
          - text: "Implied move"
      - **“🏆 Unit test · 40 XP…”** → `<div>`
        - box: 70.5x78 · transform: matrix(1, 0, 0, 1, -35.2422, 0) · position: absolute [428px 106.516px 136px 177px] · type: align-center
        - **"🏆"** → `<div>`
          - box: 62x62 · display: grid · align: center · justify-items: center · grid-cols: 58px · grid-rows: 58px · width: 58px · height: 58px · bg: T.neutral-0 · border: 2px solid T.orange-100 · radius: 50% (T.r21) · shadow: T.orange-100-e 0px 4px 0px 0px · type: 18px · scale: T.ty29
          - text: "🏆"
        - **"Unit test · 40 XP"** → `<div>`
          - box: 70.5x11 · margin: 5px 0px 0px 0px · type: color T.orange-400 / 9.5px / w600 · scale: T.ty120
          - text: "Unit test · 40 XP"
      - **“🎁 XP chest…”** → `<div>`
        - box: 48x62 · position: absolute [96px 28.3125px 484px 277.688px] · type: align-center
        - **"🎁"** → `<div>`
          - box: 48x48 · display: grid · align: center · justify-items: center · grid-cols: 46px · grid-rows: 46px · width: 46px · height: 46px · bg: T.neutral-0 · border: 1px solid T.orange-100-c · radius: 12px (T.r13) · type: 18px · scale: T.ty29
          - text: "🎁"
        - **"XP chest"** → `<div>`
          - box: 48x10 · margin: 4px 0px 0px 0px · type: color T.orange-400 / 8.5px · scale: T.ty141
          - text: "XP chest"
      - **“🎬 Motion recap…”** → `<div>`
        - box: 51.6x62 · position: absolute [322px 274.047px 258px 28.3125px] · type: align-center
        - **"🎬"** → `<div>`
          - box: 48x48 · display: grid · align: center · justify-items: center · grid-cols: 46px · grid-rows: 46px · width: 46px · height: 46px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 12px (T.r13) · type: 18px · scale: T.ty29
          - text: "🎬"
        - **"Motion recap"** → `<div>`
          - box: 51.6x10 · margin: 4px 0px 0px 0px · type: color T.orange-400 / 8.5px · scale: T.ty141
          - text: "Motion recap"
      - **“🔒 UP NEXT · UNIT 3 Options Basics · 6 l…”** → `<div>`
        - box: 354x60 · display: flex · align: center · gap: 11px · pad: 11px 14px 11px 14px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 14px (T.r15) · position: absolute [582px 0px 0px 0px]
        - **"🔒"** → `<span>`
          - box: 36x36 · display: grid · align: center · justify-items: center · grid-cols: 34px · grid-rows: 34px · width: 34px · height: 34px · flex: 0 0 auto · flex-shrink: 0 · bg: T.orange-50 · border: 1px solid T.orange-100 · radius: 50% (T.r21) · type: color T.orange-400 / 13px · scale: T.ty59
          - text: "🔒"
        - **“UP NEXT · UNIT 3 Options Basics · 6 less…”** → `<div>`
          - box: 239x27 · flex: 1 1 0% · flex-grow: 1 · flex-basis: 0%
          - **"Up next · Unit 3"** → `<div>`
            - box: 239x10 · type: color T.orange-400 / IBM Plex Mono / 8px / ls 1.12px / uppercase · scale: T.ty152
            - text: "Up next · Unit 3"
          - **"Options Basics · 6 lessons"** → `<div>`
            - box: 239x15 · margin: 2px 0px 0px 0px · type: color T.orange-700 / 12.5px / w700 · scale: T.ty65
            - text: "Options Basics · 6 lessons"
        - **"80 XP"** → `<span>`
          - box: 27x11 · type: color T.orange-500 / IBM Plex Mono / 9px · scale: T.ty127
          - text: "80 XP"
...
| T.orange-100-d | `#FFDFC2` | gradient |
| T.orange-100-e | `#D9D3C8` | shadow |
| T.orange-100-g | `#F2CFA6` | border |
