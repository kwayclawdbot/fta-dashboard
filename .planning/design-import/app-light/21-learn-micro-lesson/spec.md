...
Canvas: **CHEAT CODE · LIGHT THEME · SAME SYSTEM** · board index 20 · slug `21-learn-micro-lesson`
...
- **“✕ 3/5 The company beat earnings but the …”** → `<div>`
  ...
  - **“✕ 3/5 The company beat earnings but the …”** → `<div>`
    ...
    - **“✕ 3/5…”** → `<div>`
      ...
      - **"✕"** → `<span>`
        - box: 11.4x19 · type: color T.neutral-500 / 15px · scale: T.ty42
        - text: "✕"
      - **block[1]** → `<div>`
        - box: 298.8x10 · height: 10px · flex: 1 1 0% · flex-grow: 1 · flex-basis: 0% · bg: T.orange-100 · radius: 5px (T.r6) · overflow: hidden
        - **block[0]** → `<div>`
          - box: 179.3x10 · width: 60% · height: 100% · bg-image: linear-gradient(90deg, T.orange-400-b, T.orange-300) · radius: 5px (T.r6)
      - **"3/5"** → `<span>`
        - box: 19.8x14 · type: color T.orange-500 / IBM Plex Mono / 11px / w600 · scale: T.ty87
        - text: "3/5"
    - **"The company beat earnings but the stock drop"** **(MOCK)** → `<div>`
      - box: 354x46.8 · margin: 20px 0px 0px 0px · type: color T.orange-900 / 18px / w800 / ls -0.18px / lh 23.4px · scale: T.ty32
      - text: "The company beat earnings but the stock dropped 8%. Why?"
    - **“ANIMATED SCENE · 12S EPS BEAT ✓ −8%…”** → `<div>`
      - box: 354x182 · height: 180px · margin: 14px 0px 0px 0px · bg-image: linear-gradient(140deg, T.lime-50 0%, T.neutral-0 55%, T.orange-50-b 100%) · border: 1px solid T.orange-100 · radius: 18px (T.r17) · overflow: hidden · position: relative [0px 0px 0px 0px]
      - **“ANIMATED SCENE · 12S…”** → `<div>`
        - box: 137.8x11 · display: flex · align: center · gap: 6px · position: absolute [10px 202.188px 159px 12px]
        - **block[0]** → `<span>`
          - box: 6x6 · width: 6px · height: 6px · bg: T.orange-400-b · radius: 50% (T.r21)
        - **"Animated scene · 12s"** → `<span>`
          - box: 125.8x11 · type: color T.neutral-500 / IBM Plex Mono / 8.5px / ls 1.19px / uppercase · scale: T.ty146
      ...
      - **svg** → `<svg>`
        ...
        - svg: `<svg data-dc-tpl="1689" width="100%" height="100%" viewBox="0 0 354 180" preserveAspectRatio="none">
              <path data-dc-tpl="1690" d="M20 96 L60 88 L100 92 L140 70 L180 76 L220 58" fill="none" stroke="#0BA05A" stroke-width="2.5"></path>
      ...
      - **"EPS BEAT ✓"** → `<span>`
        - box: 68x15 · pad: 2px 7px 2px 7px · bg: T.neutral-0a85 · radius: 6px (T.r7) · position: absolute [25.1875px 100.938px 139.812px 183.031px] · type: color T.amber-500 / IBM Plex Mono / 9px · scale: T.ty127
        - text: "EPS BEAT ✓"
      - **"−8%"** **(MOCK)** → `<span>`
        - box: 30.2x15 · pad: 2px 7px 2px 7px · bg: T.neutral-0a85 · radius: 6px (T.r7) · position: absolute [131px 10px 34px 311.797px] · type: color T.red-400 / IBM Plex Mono / 9px · scale: T.ty127
        - text: "−8%"
      - **block[4]** → `<div>`
        ...
        - **block[0]** → `<div>`
          - box: 13x16 · width: 0px · height: 0px · margin: 0px 0px 0px 4px · border: T:8px solid T.neutral-950a00 R:0px none T.neutral-950 B:8px solid T.neutral-950a00 L:13px solid T.orange-50
    - **“A The beat was priced in already B Guida…”** → `<div>`
      ...
      - **“A The beat was priced in already…”** → `<div>`
        - box: 354x52 · display: flex · align: center · gap: 11px · pad: 13px 15px 13px 15px · bg: T.neutral-0 · border: 1px solid T.orange-100 · radius: 14px (T.r15)
        - **"A"** → `<span>`
          - box: 24x24 · display: grid · align: center · justify-items: center · grid-cols: 24px · grid-rows: 24px · width: 24px · height: 24px · flex: 0 0 auto · flex-shrink: 0 · bg: T.orange-100 · radius: 8px (T.r9) · type: color T.neutral-500 / IBM Plex Mono / 11px · scale: T.ty89
          - text: "A"
        - **"The beat was priced in already"** → `<span>`
          - box: 178.6x16 · type: color T.orange-800 / 13px · scale: T.ty59
          - text: "The beat was priced in already"
      - **“B Guidance came in below expectations…”** → `<div>`
        - box: 354x52 · display: flex · align: center · gap: 11px · pad: 13px 15px 13px 15px · bg: T.orange-400a08 · border: 1px solid T.orange-400-b · radius: 14px (T.r15) · shadow: T.orange-400a12 0px 0px 10px 0px
        - **"B"** → `<span>`
          - box: 24x24 · display: grid · align: center · justify-items: center · grid-cols: 24px · grid-rows: 24px · width: 24px · height: 24px · flex: 0 0 auto · flex-shrink: 0 · bg: T.orange-400-b · radius: 8px (T.r9) · type: color T.orange-900 / IBM Plex Mono / 11px / w700 · scale: T.ty96
          - text: "B"
        - **"Guidance came in below expectations"** → `<span>`
          - box: 231.1x16 · type: color T.orange-900 / 13px / w600 · scale: T.ty64
      ...
      - **“C Short sellers attacked the print…”** → `<div>`
        ...
        - **"Short sellers attacked the print"** → `<span>`
          - box: 182.4x16 · type: color T.orange-800 / 13px · scale: T.ty59
      ...
      - **“D The market was closed…”** → `<div>`
        ...
        - **"The market was closed"** → `<span>`
          - box: 135.9x16 · type: color T.orange-800 / 13px · scale: T.ty59
          - text: "The market was closed"
  - **“+10 XP Check…”** → `<div>`
    - box: 390x81 · pad: 12px 18px 24px 18px · border: T:1px solid T.orange-100 R:0px none T.neutral-950 B:0px none T.neutral-950 L:0px none T.neutral-950
    - **“+10 XP Check…”** → `<div>`
      - box: 354x44 · display: flex · align: center · gap: 10px
      - **"+10 XP"** **(MOCK)** → `<span>`
        - box: 36x13 · flex: 0 0 auto · flex-shrink: 0 · type: color T.amber-500 / IBM Plex Mono / 10px · scale: T.ty108
        - text: "+10 XP"
      - **"Check"** → `<div>`
        - box: 308x44 · flex: 1 1 0% · flex-grow: 1 · flex-basis: 0% · pad: 13px 0px 13px 0px · bg: T.orange-400-b · radius: 20px (T.r18) · shadow: T.orange-400a20 0px 0px 12px 0px · type: color T.orange-900 / 14px / w800 / align-center · scale: T.ty51
        - text: "Check"
